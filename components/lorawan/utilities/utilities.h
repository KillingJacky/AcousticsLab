 ...
 *
 * \param [IN] hexStr Pointer to the hexadecimal string
 * \param [OUT] byteArray Pointer to the output byte array
 * \param [IN] byteArraySize Size of the output byte array
 * \retval int Number of bytes converted or 0 if an error occurred
 */
int hexStringToBytes(const char *hexStr, unsigned char *byteArray, size_t byteArraySize);
